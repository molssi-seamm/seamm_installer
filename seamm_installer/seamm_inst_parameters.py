# -*- coding: utf-8 -*-
"""
Control parameters for the SEAMM Installer step in a SEAMM flowchart
"""
...
class SeammInstallerParameters(seamm.Parameters):
    """
    ...
    See Also
    --------
    SeammInstaller, TkSeammInstaller, SeammInstaller
    SeammInstallerParameters, SEAMM InstallerStep
    ...
    def __init__(self, defaults={}, data=None):
        ...
        logger.debug('SeammInstallerParameters.__init__')

        super().__init__(
            defaults={**SeammInstallerParameters.parameters, **defaults},
            data=data
        )
