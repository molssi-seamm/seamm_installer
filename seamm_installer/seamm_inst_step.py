...
class SeammInstallerStep(object):
    ...
    my_description['description'] : tuple
        A description of the SEAMM Installer step. It must be
    ...
    my_description = {
        'description':
            (
                'An interface for SEAMM Installer'
            ),
        'group': 'Simulations',
    ...
    def description(self):
        ...
        """
        return SeammInstallerStep.my_description
    ...
    def create_node(self, flowchart=None, **kwargs):
        ...
        **kwargs : keyworded arguments
        ...
        return seamm_installer.SeammInstaller(flowchart=flowchart, **kwargs)
    ...
    def create_tk_node(self, canvas=None, **kwargs):
        ...
        **kwargs : keyworded arguments
        ...
        return seamm_installer.TkSeammInstaller(canvas=canvas, **kwargs)
